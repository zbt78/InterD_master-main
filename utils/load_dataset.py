...
def seed_randomly_split(df, ratio, split_seed, shape, type=None):
    ...
    permute_indices = np.random.permutation(num_nonzeros) # 对 0-num_nonzeros 之间的数随机排序，用于生成随机索引
    ...
    if type == 'implicit': 
        ...
        # csr_matrix 稀疏矩阵，value = train_imp['rating']  row,col = train_imp['uid'], train_imp['iid']
